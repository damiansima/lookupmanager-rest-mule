...
-----------------------------------------------------------------
./src/test/java/org/mule/application/lookupmanagerrestmule1/Lookupmanagerrestmule1TestCase.java
...
-----------------------------------------------------------------
./src/test/resources/lookupmanagerrestmule1-functional-test-config.xml

Defines the Mule configuration for the Lookupmanagerrestmule1TestCase.java.
...
artifactId=lookupmanagerrestmule1
description=
muleVersion=3.2.1
packagePath=com/mycompany/mule
forgeProject=n
transports=file,http,jdbc,jms,vm
modules=jersey,client

version=1.0-SNAPSHOT
groupId=org.mule.application
basedir=/Users/damiansima/Documents/workspace
--------------------------------------------------------------------